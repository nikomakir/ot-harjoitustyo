...
class Menu:
    ...
    def _render(self):
        ...
        new_game_button = self._font.render("New Game",True,"black",self._button_color)
        resume_button = self._font.render("Resume Game",True,"gray",self._button_color)
        quit_button = self._font.render("Quit",True,"black",self._button_color)
